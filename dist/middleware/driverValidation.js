...
exports.validateDriverUpdate = exports.validateDriverCreate = void 0;
const error_1 = require("./error");
// Validate driver creation
const validateDriverCreate = (req, res, next) => {
    const { fullName, email, phone, address, city, state, vehicleType, vehiclePlateNumber, region, employmentType } = req.body;
    const errors = {};
...
exports.validateDriverCreate = validateDriverCreate;
...
exports.validateDriverUpdate = validateDriverUpdate;
