...
exports.getSearchHistory = exports.refreshToken = exports.logout = exports.getMe = exports.updateBiometricSettings = exports.updateNotificationSettings = exports.completeProfile = exports.resendOTP = exports.verifyOTP = exports.sendOTP = exports.verifyLoginOTP = exports.login = void 0;
...
exports.getSearchHistory = (0, error_1.asyncHandler)(async (req, res, next) => {
    if (!req.user) {
        return next(new error_1.AppError('Not authenticated', 401));
    }
    const users = await User_1.default.find().select('searchHistory');
