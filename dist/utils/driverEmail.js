...
exports.driverEmailTemplates = exports.sendEmail = void 0;
...
exports.driverEmailTemplates = {
    passwordSetup: (fullName, setupUrl) => `
        <!DOCTYPE html>
        <html>
        <head>
            <style>
    ...
    `,
    passwordSetupResend: (fullName, setupUrl) => `
        <!DOCTYPE html>
        <html>
        <head>
            <style>
    ...
    `,
    verificationApproved: (fullName, loginUrl) => `
        <!DOCTYPE html>
        <html>
        <head>
            <style>
    ...
    `,
    verificationRejected: (fullName, reason) => `
        <!DOCTYPE html>
        <html>
        <head>
            <style>
    ...
    `,
    accountSuspended: (fullName, reason, duration, suspendedUntil) => `
        <!DOCTYPE html>
        <html>
        <head>
            <style>
    ...
    `,
    accountDisabled: (fullName, reason) => `
        <!DOCTYPE html>
        <html>
        <head>
            <style>
...
//# sourceMappingURL=driverEmail.js.map